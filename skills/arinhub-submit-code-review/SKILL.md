...
description: 'Submit code review from chat session or review file to a GitHub PR. Use when asked to "submit PR review", "submit review to PR 123", or "submit code review". Creates line-specific review comments with suggestions.'
