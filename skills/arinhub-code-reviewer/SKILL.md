...
description: Review code for correctness, maintainability, and adherence to project standards. Supports local changes (staged or working tree) and remote Pull Requests (by ID or URL). Use when asked to "ah review PR 123", "ah review my changes", "ah review local changes", or "ah review pr #123".
