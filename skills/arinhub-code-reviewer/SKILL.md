...
description: "Orchestrate a comprehensive code review by launching parallel review subagents, deduplicating findings, and submitting the review. Use when asked to 'review PR', 'code review PR #123', 'arinhub review', 'full PR review', 'review my changes', or 'review local changes'. Input: PR number, URL, or nothing for local changes."
